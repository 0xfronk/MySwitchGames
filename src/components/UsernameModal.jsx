...
export const UsernameModal = ({ setUsernameFormToggle, documentID }) => {
  ...
  return (
    <form
      ...
      className="bg-background-1000 h-auto max-w-xl rounded-lg overflow-scroll flex flex-col px-8 py-8 text-neutral-50 justify-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
    >
